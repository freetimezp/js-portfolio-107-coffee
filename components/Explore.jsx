...
import exploreImg from "../public/assets/explore/cup.png";
import coffeeImg1 from "../public/assets/explore/coffees/coffee-1.svg";
import coffeeImg2 from "../public/assets/explore/coffees/coffee-2.svg";
import coffeeImg3 from "../public/assets/explore/coffees/coffee-3.svg";
import coffeeImg4 from "../public/assets/explore/coffees/coffee-4.svg";
        ...
        <section className='py-12 xl:py-0 xl:h-[90vh] xl:w-screen'>
            <div className="container mx-auto xl:w-full xl:h-full flex xl:justify-center
                ...
                <div className='w-full flex flex-col lg:flex-row gap-12 
                    xl:gap-20'>
                    <div className='flex-1 flex flex-col justify-around items-end text-center
                        xl:text-left gap-12 xl:gap-0 max-w-[400px] mx-auto xl:max-w-none
                        xl:mx-0'>
                        {/* item 1 */}
                        <div className="relative flex items-start">
                            <div className='xl:max-w-[420px] xl:text-right xl:flex xl:flex-col
                                xl:items-end'>
                    ...
                    <div className='flex-1 flex flex-col justify-around items-end text-center
                        ...
                        {/* item 3 */}
                        <div className="relative flex items-start">
                            <div className='xl:max-w-[420px] xl:text-left xl:flex xl:flex-col
                                xl:items-start'>
                                <div className='mb-6 flex justify-center items-center'>
                                    <Image
                                        src={coffeeImg3}
